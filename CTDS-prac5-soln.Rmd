...
#  Narrative regarding activity

<to be written, or borrowed from Prac2>
...
duiker.boot.hr <- bootdht(model=hr0, flatfile=DuikerCameraTraps, resample_transects = TRUE,
                       nboot=40, summary_fun=mysummary, sample_fraction = samfrac,
...
- Questions will be dependent upon what data set used
  - <p style="color: blue; font-size: 110%; font-style: italic;">Answer</p>
