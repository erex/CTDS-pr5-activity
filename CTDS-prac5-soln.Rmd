...
The file containing the start times of video cameras forms the basis of temporal availability calculations.  Data from the camera logs are stored in a text file, `VideoStartTimes_FullDays.txt` and need to be massaged so the data can be analysed by the `activity` package [@activity_pkg].
...
daytime.boot.hr <- bootdht(model=daytime.hr0, flatfile=daytime,
                          resample_transects = TRUE, nboot=200, cores = 3,
